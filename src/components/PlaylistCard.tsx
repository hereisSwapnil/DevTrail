...
import { CheckCircle2, Play, Trash2, MoreHorizontal } from 'lucide-react';
...
export function PlaylistCard({ playlist, onOpen, index = 0 }: PlaylistCardProps) {
  ...
  const coverThumbnail = playlist.videos.find(v => v.thumbnail)?.thumbnail;
